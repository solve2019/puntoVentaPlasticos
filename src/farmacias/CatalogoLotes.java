 ...
 * @author desarrollo8
 */
public class CatalogoLotes extends javax.swing.JInternalFrame {
private static TableRowSorter<TableModel> sorter;
    /**
     * Creates new form Productos
     */
    public CatalogoLotes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jtproductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Lote", "Descripcion", "Cantidad", "Fecha", "Usuario Registro"
            }
        ));
         ...
         int fila=-1;
            ...
            if(fila!=-1){
                ...
                if(opc==JOptionPane.OK_OPTION){
                    ...
                    conex con=new conex();                                               
                    try {
                        String myQuery = "update farmacia_to_lotes set estatus=0,usuario_elimino='"+accesoSistema.nombreuser+"',fecha_baja=now() where Id_lotes='"+id+"'";
                        Statement st = con.getConnection().createStatement();
                        st.executeUpdate(myQuery);
                        st.close();
                        con.desconectar();
                        cargartabla();
                        JOptionPane.showMessageDialog(null, "El lote se elimino correctamente. ", "Producto eliminado", JOptionPane.PLAIN_MESSAGE);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        NuevoLote venta=new NuevoLote(f,true);
        venta.show();
    ...
    public static String cargarcate(String idcate){
        String categoria="";
        if(idcate==null){
        }else{
                    conex con=new conex();   
    ...
    public static void cargartabla(){   
        ...
        String myQuery = "select * from farmacia_to_lotes where estatus=1"+sqlaux+"";
               System.out.println(""+myQuery);
               try {
                   Statement st = con.getConnection().createStatement();
                   rsR = st.executeQuery(myQuery);
                   while(rsR.next()) {                             
                            modelo.addRow(new Object[]{rsR.getString("Id_lotes"),rsR.getString("lote"),rsR.getString("descripcion"),rsR.getString("cantidad"),rsR.getString("fecha"),rsR.getString("usuario_registro")});                        
                   }
