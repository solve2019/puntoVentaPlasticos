 ...
 * @author desarrollo8
 */
public class catalogo_productosCompuesto extends javax.swing.JDialog {

    /**
     * Creates new form catalogo_productos
     */
    public catalogo_productosCompuesto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DefaultTableModel modelo=(DefaultTableModel) jtprod.getModel();  
          ...
          if(fila!=-1){
            ...
            EdicionProducto.cargar_producto(codigobarras,"ID");
            dispose();
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // TODO add your handling code here:
         ...
         EdicionProducto.txtcb.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogo_productosCompuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                catalogo_productosCompuesto dialog = new catalogo_productosCompuesto(new javax.swing.JFrame(), true);
