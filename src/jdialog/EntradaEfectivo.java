...
public class EntradaEfectivo extends javax.swing.JDialog {
     ...
     */
    public EntradaEfectivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EntradaEfectivo dialog = new EntradaEfectivo(new javax.swing.JFrame(), true);
        ...
        if(monto.equals("")){
            ...
            if(validador==true){
                ...
                try {
                    ...
                    sql="insert into th_entradasefectivo (fecha,monto,motivo,movimiento,usuario) values(now(),'"+montook+"','"+txtnota.getText().trim()+"','ENTRADA','"+accesoSistema.nombreuser+"')";                                                   
                    st.executeUpdate(sql);
                    ...
                    JOptionPane.showMessageDialog(null, "La entrada de efectivo se realizo correctamente.", "Registro de Entrada", JOptionPane.INFORMATION_MESSAGE);        
                    dispose();
