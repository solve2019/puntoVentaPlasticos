 ...
 * @author desarrollo8
 */
public class catalogo_Clientes extends javax.swing.JDialog {

    /**
     * Creates new form catalogo_productos
     */
    public catalogo_Clientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DefaultTableModel modelo=(DefaultTableModel) jtprod.getModel();  
          ...
          if(fila!=-1){
            ...
            //Ventas.cargar_cliente(cliente+"-"+id);            
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogo_Clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                catalogo_Clientes dialog = new catalogo_Clientes(new javax.swing.JFrame(), true);
