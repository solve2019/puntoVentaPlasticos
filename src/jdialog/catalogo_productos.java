 ...
 * @author desarrollo8
 */
public class catalogo_productos extends javax.swing.JDialog {

    /**
     * Creates new form catalogo_productos
     */
    public catalogo_productos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DefaultTableModel modelo=(DefaultTableModel) jtprod.getModel();  
          ...
          if(fila!=-1){
            ...
            //Ventas.cargar_productobusqueda(codigobarras);    
            Ventas.cargar_producto(codigobarras,"ID");
            dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                catalogo_productos dialog = new catalogo_productos(new javax.swing.JFrame(), true);
    ...
    public void cargatabla(String producto){
        ...
        //jtprod.requestFocus();
        //jtprod.changeSelection(jtprod.getRowCount() - 1, 1, false, false);
        ...
        jtprod.getColumnModel().getColumn(0).setMaxWidth(150);
        jtprod.getColumnModel().getColumn(0).setMinWidth(150);
        jtprod.getColumnModel().getColumn(0).setPreferredWidth(150);
        jtprod.getColumnModel().getColumn(0).setWidth(150);
        
        jtprod.getColumnModel().getColumn(2).setMaxWidth(80);
        jtprod.getColumnModel().getColumn(2).setMinWidth(80);
        jtprod.getColumnModel().getColumn(2).setPreferredWidth(80);
        jtprod.getColumnModel().getColumn(2).setWidth(80);
        
        jtprod.getColumnModel().getColumn(3).setMaxWidth(80);
        jtprod.getColumnModel().getColumn(3).setMinWidth(80);
        jtprod.getColumnModel().getColumn(3).setPreferredWidth(80);
        jtprod.getColumnModel().getColumn(3).setWidth(80);
    }
    
    
    public void cargatabla2(String producto){
        vaciartabla();
        conex conlocal=new conex();                   
        ResultSet rs = null;
        DefaultTableModel modelo=(DefaultTableModel) jtprod.getModel();  
