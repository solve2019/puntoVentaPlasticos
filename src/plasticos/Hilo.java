...
public class Hilo extends Thread { 
    ...
    private final int TIEMPO = 1000;         // tiempo en milisegundos que estara activa la ventana
    ...
    public static void main(String[] args) { 
        Hilo hilo = new Hilo(); 
        hilo.agregarTexto("Producto agregado correctamente!", 0); 
        hilo.start(); 
        //hilo.agregarTexto("Producto agregado correctamente!", 1); 
        //hilo.agregarTexto("Producto agregado correctamente!", 2); 
    } 
    ...
    class Ventana extends JDialog { 
        ...
        private void iniciarComponentes() { 
            ...
            setPreferredSize(new java.awt.Dimension(380, 100));           // tamaño de la ventana
            ...
            textoPane.setFont(new java.awt.Font("Tahoma", 1, 26)); // NOI18N
