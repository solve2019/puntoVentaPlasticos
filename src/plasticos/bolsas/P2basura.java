 ...
 * @author desarrollo8
 */
public class P2basura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BOLSA NEGRA");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N
        jLabel2.setText("Premium");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N
        jLabel3.setText("Economica");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P2basura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 public void vaciartabla(){
   ...
   public void cargartabla(){    
        ...
        conex con=new conex();   
        ResultSet rsR = null;                
        String myQuery = "select idproducto,nombre_producto,precio_venta,precio_mayoreo,cantidad_mayoreo from tc_productos,tc_categorias where Idcategoria=idrcategoria and nombre='bolsa-negra-premium' and tc_productos.estatus=1";
   ...
   public void cargartabla2(){    
        ...
        conex con=new conex();   
        ResultSet rsR = null;                
        String myQuery = "select idproducto,nombre_producto,precio_venta,precio_mayoreo,cantidad_mayoreo from tc_productos,tc_categorias where Idcategoria=idrcategoria and nombre='bolsa-negra-economica' and tc_productos.estatus=1";
               //System.out.println(""+myQuery);
               try {
                   Statement st = con.getConnection().createStatement();
                   rsR = st.executeQuery(myQuery);
