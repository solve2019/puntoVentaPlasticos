 ...
 * @author desarrollo8
 */
public class P2aluminio extends javax.swing.JFrame {
    ...
    public P2aluminio() {
        ...
        lblopcion.setText("ALUMINIO");
        cargartabla("desechables-aluminio");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DESECHABLES ALUMINIO");

        lblopcion.setFont(new java.awt.Font("Tahoma", 0, 22)); // NOI18N

        jButton2.setText("ALUMINIO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P2aluminio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P2aluminio().setVisible(true);
            }
        });
    }
