 ...
 * @author SOLVEMORELOS
 */
public class Cantidades extends javax.swing.JDialog {
String idprod="0";
String preciocosto="0.0";
    /**
     * Creates new form Cantidades
     */
    public Cantidades(java.awt.Frame parent, boolean modal,String id,String desc,String precio) {
        super(parent, modal);
        idprod=id;
        preciocosto=precio;
        initComponents();
        lblprod.setText(desc);
    ...
    private void initComponents() {
        ...
        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/palomita.png"))); // NOI18N
        ...
        txtcantidad.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        txtcantidad.setForeground(new java.awt.Color(51, 255, 0));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblprod, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String val=txtcantidad.getText().trim();
        if(val.length()>=5){            
        }else{
            txtcantidad.setText(val+"1");
        }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        if(cantidad.equals("")){
            JOptionPane.showMessageDialog(null, "Ingrese la cantidad.","Alerta",JOptionPane.ERROR_MESSAGE);
        }else{
            try{
            float cant=Float.parseFloat(cantidad);
            txtcantidad.setText("");
            txtprecio.setText("");
            //Pos_Ventas.cargar_productotouch(idprod,"ID",cant+"");            
            Ventas.cargar_productotouch(idprod,"ID",cant+"",precio);            
            dispose();
            Hilo hilo = new Hilo(); 
            ...
            hilo.start(); 
                ...
                txtcantidad.setText("");
                JOptionPane.showMessageDialog(null, "Cantidad Erronea vuelva a digitar. "+e,"Error",JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cantidades dialog = new Cantidades(new javax.swing.JFrame(), true,"0","","");
