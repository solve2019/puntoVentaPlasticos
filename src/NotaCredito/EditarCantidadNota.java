 ...
 * @author desarrollo8
 */
public class EditarCantidadNota extends javax.swing.JDialog {
int fila;
String precios,ids;
String existencias;
    /**
     ...
     */
    public EditarCantidadNota(java.awt.Frame parent, boolean modal,int filas, String producto, String cantidad, String precio, String existencia,String descuento,String id) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCantidadNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarCantidadNota dialog = new EditarCantidadNota(new javax.swing.JFrame(), true,1,"","","","","","");
    ...
    public void cargarcantidad(){
        ...
        try {  
            ...
            NotaCredito.jtproductosnota.setValueAt(preci+"", fila, 2);
            NotaCredito.jtproductosnota.setValueAt(cantidadnueva, fila, 3);
            NotaCredito.jtproductosnota.setValueAt(total+"", fila, 4);
            NotaCredito.jtproductosnota.setValueAt(existen+"", fila, 5);            
            NotaCredito.jtproductosnota.setValueAt(descuento+"", fila, 7);            
            
            NotaCredito.cargar_informacion();            
