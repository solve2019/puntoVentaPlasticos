 ...
 * @author desarrollo8
 */
public class catalogo_ClientesNota extends javax.swing.JDialog {

    /**
     * Creates new form catalogo_productos
     */
    public catalogo_ClientesNota(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Teclee las primeras letras del cliente, o una coincidencia del mismo.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DefaultTableModel modelo=(DefaultTableModel) jtprod.getModel();  
          ...
          if(fila!=-1){
            String id=jtprod.getValueAt(fila, 0).toString();            
            String cliente=jtprod.getValueAt(fila, 1).toString();            
            NotaCredito.cargar_cliente(cliente+"-"+id);            
            dispose();
            
          }else{
            JOptionPane.showMessageDialog(null, "Seleccionar un cliente de la tabla.","Alerta",JOptionPane.ERROR_MESSAGE);
          }
    ...
    private void txtclienteKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtclienteKeyTyped
        ...
        cargatabla(txtcliente.getText().trim());
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        NotaCredito.txtproductonota.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogo_ClientesNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                catalogo_ClientesNota dialog = new catalogo_ClientesNota(new javax.swing.JFrame(), true);
    ...
    public void cargatabla(String producto){
        ...
        try {
            ...
            String consul="select * from tc_clientes where nombre_completo like '%"+producto+"%'";
            System.out.println(""+consul);
            rs = st.executeQuery(consul);
            while(rs.next()) {                     
                modelo.addRow(new Object[]{""+rs.getString("idcliente"),""+rs.getString("nombre_completo"),""+rs.getString("rfc")});
            }
            rs.close();
