 ...
 * @author desarrollo8
 */
public class catalogo_productosProveedor extends javax.swing.JDialog {

    /**
     * Creates new form catalogo_productos
     */
    public catalogo_productosProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jtprod.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Barras", "Descripción", "Precio Compra", "Existencia", "Id"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DefaultTableModel modelo=(DefaultTableModel) jtprod.getModel();  
          ...
          if(fila!=-1){
            ...
            Proveedores.cargar_productobusqueda(codigobarras);            
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogo_productosProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                catalogo_productosProveedor dialog = new catalogo_productosProveedor(new javax.swing.JFrame(), true);
    ...
    public void cargatabla(String producto){
        ...
        try {
            ...
            while(rs.next()) {                     
                modelo.addRow(new Object[]{""+rs.getString("codigo_barras"),""+rs.getString("nombre_producto"),""+rs.getString("precio_compra"),""+rs.getString("existencia"),""+rs.getString("idproducto")});
            }
            rs.close();
