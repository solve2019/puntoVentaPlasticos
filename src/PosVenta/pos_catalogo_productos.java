 ...
 * @author desarrollo8
 */
public class pos_catalogo_productos extends javax.swing.JDialog {

    /**
     * Creates new form catalogo_productos
     */
    public pos_catalogo_productos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DefaultTableModel modelo=(DefaultTableModel) jtprod.getModel();  
          ...
          if(fila!=-1){
            ...
            Pos_Ventas.cargar_producto(codigobarras,"ID");
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pos_catalogo_productos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pos_catalogo_productos dialog = new pos_catalogo_productos(new javax.swing.JFrame(), true);
