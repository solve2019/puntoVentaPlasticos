 ...
 * @author desarrollo8
 */
public class Pos_EditarCantidad extends javax.swing.JDialog {
int fila;
String precios,ids;
String existencias;
String idproduc;
     ...
     */
    public Pos_EditarCantidad(java.awt.Frame parent, boolean modal,int filas, String producto, String cantidad, String precio, String existencia,String idprod) {
        super(parent, modal);
        initComponents();
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        // TODO add your handling code here:
         Pos_Ventas.txtproducto.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pos_EditarCantidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Pos_EditarCantidad dialog = new Pos_EditarCantidad(new javax.swing.JFrame(), true,1,"","","","","");
    ...
    public void cargarcantidad(){
        ...
        if(descuento.equals("")){
            ...
            Pos_Ventas.jtproductos.setValueAt(preci+"", fila, 2);
            Pos_Ventas.jtproductos.setValueAt(cantidadnueva, fila, 3);
            Pos_Ventas.jtproductos.setValueAt(total+"", fila, 4);
            Pos_Ventas.jtproductos.setValueAt(existen+"", fila, 5);
            Pos_Ventas.jtproductos.setValueAt(descuento+"", fila, 7);                        
            Pos_Ventas.jtproductos.setValueAt(ieps+"", fila, 8);                        
            Pos_Ventas.cargar_informacion();            
